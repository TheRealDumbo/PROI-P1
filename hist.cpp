...
hist::hist()
{
    int j;
    iloscall=0;
    std::cout<<"Prosze wpisac tresc tekstu:"<<std::endl;
    getline(std::cin, tekst); // pobranie tekstu
...
{
    std::string ntekst;
    std::cout<<"Prosze wpisac tresc kontynuacji tekstu:"<<std::endl;
    getline(std::cin, ntekst);
    tekst+=ntekst; // skleja nowy tekst, z tym przechowywanym w klasie
    int j;
